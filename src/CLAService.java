...
public class CLAService
{
    ...
    /**
     * Constructor for class CLAService.
     *
    ...
    /**
     * Executes an instance of the CLAService.
     *
     * @param String CTFServerName: provides the address of the machine running the CTF.
     */
    public static void main(String args[]) throws Exception
    {
        ...
        System.out.println("-- by Joseph Klaash");        
        System.out.println();
    ...
    /**
     * Starts the CLAService by adding the Security provider, reading in all configuration
     ...
     * that are requesting communication of data from the CLAService.
     */
